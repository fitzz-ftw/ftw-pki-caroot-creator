...
>>> from ftwpki.ca_root_creator.cli_parser import CaInitParser_DEV

>>> pki_file: Path|None = None

>>> pre_parser = CaInitParser_DEV(prog="ftwpkicaroot", add_help=False, allow_abbrev=False)
>>> pre_args , _ = pre_parser.parse_known_args(sys_argv)
>>> ca_parser = CaInitParser_DEV(prog="ftwpkicaroot")
